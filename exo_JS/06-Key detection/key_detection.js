...
var tab = [];
const code = ['l','o','g','a','n']

window.addEventListener('keyup', function (e) {
  tab.push(e.key)

console.log(tab)
console.log(arrayEquals(tab , code));


// mettre ce if avant le if du bas

if (arrayEquals(tab , code)){ 
  cornify_add()
console.log("ok")
}

// si je met ce if ça marchera pas car ça réanisialise le tableau
// on peut aussi augmenter la taille du tableau a 2 ça evite de changer la place du if
if (tab.length > 6){
 tab = []
}
